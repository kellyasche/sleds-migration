...
* Individuals that do attend post-secondary but not within the first year have a significantly higher proportion of individuals that have meaningful employment in the same county as their high school - 18.2%; 341 individuals observed vs. 231 expected.
* In addition, a higher proportion of individuals that never attended PS have meaningful employment in the same county as their high school - 16.6%; 1,462 observed vs. 1,087 expected.

<br>

#### attended.ps.within.first.year.hsgrad

```{r ct attending post-secondary within first year after hs graduation}
tab_xtab(var.row = master.grad.year.ct$`County match`, var.col = master.grad.year.ct$attended.ps.within.first.year.hsgrad, 
         title = "Test", 
         show.exp = TRUE,
         show.col.prc = TRUE)
```
...
* Individuals that do attend post-secondary but not within the first year have a significantly higher proportion of individuals that have meaningful employment in the same EDR as their high school - 21.3%; 397 individuals observed vs. 277 expected.
* In addition, a higher proportion of individuals that never attended PS have meaningful employment in the same EDR as their high school - 20.8%; 1,815 observed vs. 1,298 expected.

<br>

#### attended.ps.within.first.year.hsgrad

```{r ct attending post-secondary within first year after hs graduation edr}
tab_xtab(var.row = master.grad.year.edr.ct$`EDR match`, var.col = master.grad.year.edr.ct$attended.ps.within.first.year.hsgrad, 
         title = "Test", 
         show.exp = TRUE,
         show.col.prc = TRUE)
```
...
* Individuals that do attend post-secondary but not within the first year AND individuals that never attend Post-secondary have a significantly higher proportion of individuals that have meaningful employment in one of the three EDRs - 23.3% for individuals that eventually attend Post-secondary but not within the first year and 23.2% of individuals that never attend post-secondary; 435 individuals observed vs. 302 expected and 2,027 oberved vs. 1,416 expected.
<br>

#### attended.ps.within.first.year.hsgrad

```{r ct attending post-secondary within first year after hs graduation region}
tab_xtab(var.row = master.grad.year.region.ct$`Region match`, var.col = master.grad.year.region.ct$attended.ps.within.first.year.hsgrad, 
         title = "Test", 
         show.exp = TRUE,
         show.col.prc = TRUE)
```
...
* Individuals that do attend post-secondary but not within the first year AND individuals that never attend post-secondary have a significantly higher proportion of individuals that have meaningful employment in the same county as their high school - 28.1% and 28.2% respectively.

<br>

#### attended.ps.within.first.year.hsgrad

```{r ct attending post-secondary within first year after hs graduation MN}
tab_xtab(var.row = master.grad.year.mn.ct$`MN match`, var.col = master.grad.year.mn.ct$attended.ps.within.first.year.hsgrad, 
         title = "Test", 
         show.exp = TRUE,
         show.col.prc = TRUE)
```
...
```{r summary hs enrollment english learner}

hsenroll.english.learner.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0, 0, 0.815),
         EDR = c(0, 0, 0.970),
         `All 3 EDRs` = c(0, 0, 0.280),
         MN = c(0, 0, 0)) 

datatable(hsenroll.english.learner.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
```{r summary hs accomplishments took act}

hsaccom.took.act.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0, 0, 0),
         EDR = c(0, 0, 0),
         `All 3 EDRs` = c(0, 0, 0),
         MN = c(0, 0, 0.046)) 

datatable(hsaccom.took.act.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
```{r summary hs accomplishments took ap exam}

hsaccom.ap.exam.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0, 0, 0),
         EDR = c(0, 0, 0),
         `All 3 EDRs` = c(0, 0, 0),
         MN = c(0, 0, 0)) 
...
```{r summary hs accomplishments total cte courses taken}

hsaccom.total.cte.courses.taken.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0, 0, 0),
         EDR = c(0, 0, 0),
         `All 3 EDRs` = c(0, 0, 0),
         MN = c(0, 0, 0)) 

datatable(hsaccom.total.cte.courses.taken.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
```{r summary hs accomplishments cte achievement}

hsaccom.cte.achievement.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0, 0, 0),
         EDR = c(0, 0, 0),
         `All 3 EDRs` = c(0, 0, 0),
         MN = c(0, 0, 0)) 

datatable(hsaccom.cte.achievement.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
```{r summary hs accomplishments MCA math}

hsaccom.mca.m.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0, 0, 0),
         EDR = c(0, 0, 0),
         `All 3 EDRs` = c(0, 0, 0),
         MN = c(0, 0, 0)) 

datatable(hsaccom.mca.m.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
```{r summary hs accomplishments MCA reading}

hsaccom.mca.r.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0, 0, 0),
         EDR = c(0, 0, 0),
         `All 3 EDRs` = c(0, 0, 0),
         MN = c(0, 0, 0)) 

datatable(hsaccom.mca.r.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
```{r summary hs accomplishments MCA science}

hsaccom.mca.s.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0, 0, 0),
         EDR = c(0, 0, 0),
         `All 3 EDRs` = c(0, 0, 0),
         MN = c(0, 0, 0)) 

datatable(hsaccom.mca.s.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
### Post secondary variables{.tabset}
...
```{r summary attending post secondary within first year}

post.sec.ps.grad.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0, NA, NA),
         EDR = c(0, NA, NA),
         `All 3 EDRs` = c(0, NA, NA),
         MN = c( 0, NA, NA)) 

datatable(post.sec.ps.grad.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
```{r summary post secondary graduating from post-secondary}

post.sec.ps.grad.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( NA, 0, 0),
         EDR = c(NA, 0, 0),
         `All 3 EDRs` = c(NA, 0, 0),
         MN = c( NA, 0, 0)) 
...
```{r summary post secondary attended post-secondary}

post.sec.attended.ps.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( NA, 0, 0),
         EDR = c(NA, 0, 0.001),
         `All 3 EDRs` = c(NA, 0, 0.009),
         MN = c(NA, 0, 0)) 

datatable(post.sec.attended.ps.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
```{r summary post secondary institution sector graduating post secondary}

post.sec.ps.grad.InstitutionSector.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( NA, 0, 0),
         EDR = c(NA, 0, 0),
         `All 3 EDRs` = c(NA, 0, 0),
         MN = c(NA, 0, 0)) 

datatable(post.sec.ps.grad.InstitutionSector.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
```{r summary post secondary highest credential earned}

post.sec.highest.cred.level.pvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( NA, 0, 0),
         EDR = c(NA, 0, 0),
         `All 3 EDRs` = c(NA, 0, 0),
         MN = c(NA, 0, 0)) 

datatable(post.sec.highest.cred.level.pvalues, class = "cell-border stripe", filter = "top", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>%
  formatCurrency(2:5, "", digits = 3) %>%
  formatStyle(c("County", "EDR", "All 3 EDRs", "MN"),
              backgroundColor = styleInterval(c(.01), c("#99CC33", "#fb9a99")))
...
```{r export master}
master.after.ct <- updated.master %>%
  select(PersonID, `dep.var.names`, RaceEthnicity, Dem_Desc, edr, avg.wages.pct.state, LimitedEnglishProficiencyIndicator, pseo.participant, non.english.home, english.learner, took.ACT, ap.exam, total.cte.courses.taken, cte.achievement, MCA.M, MCA.R, MCA.S, attended.ps.within.first.year.hsgrad, ps.grad, attended.ps, ps.grad.InstitutionSector, highest.cred.level)

write_csv(master.after.ct, "Data/SLEDS/Masters/Master-after-ct.csv")
...
Next, let's compare the v-scores to see which ones have some of the highest explanation. The only v-scores provided will be for variables that had a p-value below .01.
...
The race and ethnicity variable never had a strong association. However, it was most weak seven years after graduation.

<br>

```{r summary demographic z scores}

dem.race.ethnicity.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c(0.068, 0.076, .029),
         EDR = c(0.064, 0.063, .022),
         `All 3 EDRs` = c(0.064, 0.058, .031),
         MN = c(0.062, 0.046, 0.050)) 

dem.race.ethnicity.quantile <- dem.race.ethnicity.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(dem.race.ethnicity.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(dem.race.ethnicity.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
**Dem_Desc:** The RUCA category was never strongly associated with the dependent variable. However, it was strongest during gradd year +0 and grad year +2 and at the more "local" geographies.

**EDR:** EDR was never strongly associated with the dependent variable. However, it was the strongest at grad year +2 and grad year +7, and whether meaningful employment was had in Minnesota.

<br>

#### Dem_Desc

```{r summary z scores hs characteristics dem_desc}

hschar.dem_desc.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c(0.053, 0.065, .054),
         EDR = c(0.047, 0.043, 0.049),
         `All 3 EDRs` = c(0.058, 0.063, 0.080),
         MN = c(0.054, 0.045, .072)) 


hschar.dem_desc.quantile <- hschar.dem_desc.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(hschar.dem_desc.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)
...
```{r summary z scores hs characteristics EDR}

hschar.edr.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c(0.050, 0.069, 0.059),
         EDR = c(0.043, 0.062, 0.075),
         `All 3 EDRs` = c(.015, .005, 0.040),
         MN = c(0.047, 0.059, 0.107)) 

hschar.edr.quantile <- hschar.edr.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(hschar.edr.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(hschar.edr.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
**LimitedEnglishProficiencyIndicator:** This variable was never strongly associated with the dependent variable.

**PSEO.participant:** This variable did have a somewhat strong association with the dependent variable with many of the z-scores being above .1. It was particularly strong during grad year +0 and grad year +2, and loses association passed that time.

<br>

#### LimitedEnglishProficiency

```{r summary z scores hs enrollment limited english proficiency}

hsenroll.LimitedEnglishProficiencyIndicator.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0.026, 0.012, 0.002),
         EDR = c(0.028, 0.013, 0.003),
         `All 3 EDRs` = c(0.024, 0.007, 0.011),
         MN = c(0.029, 0.006, 0.032)) 

hsenroll.LimitedEnglishProficiencyIndicator.quantile <- hsenroll.LimitedEnglishProficiencyIndicator.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(hsenroll.LimitedEnglishProficiencyIndicator.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(hsenroll.LimitedEnglishProficiencyIndicator.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
```{r summary z scores hs enrollment pseo participant}

hsenroll.pseo.participant.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0.088, 0.110, 0.068),
         EDR = c(0.100, 0.128, 0.070),
         `All 3 EDRs` = c(0.108, 0.135, 0.067),
         MN = c(0.118, 0.127, 0.009)) 

hsenroll.pseo.participant.quantile <- hsenroll.pseo.participant.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(hsenroll.pseo.participant.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(hsenroll.pseo.participant.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
**took.act:** Taking the ACT had a consistently strong-ish association with the dependent variable. It's particularly strong at grad year +0 and grad year +2.

**ap.exam:** Taking the AP Exam had a consistently strong-ish association with the dependent variable. It's particularly strong in whether there was meaningful employment in the same EDR, in one of the three EDRs, and in Minnesota during grad year +0 and grad year +2. 

**cte.achievement:** CTE achievement had a consistently strong-ish association with the dependent variable. It was particularly strong at grad year +0 and grad year +2.

<br>

#### took.act

```{r summary z scores hs accomplishments took act}

hsaccom.took.act.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0.107, 0.139, 0.089),
         EDR = c(0.122, 0.163, 0.108),
         `All 3 EDRs` = c(0.132, 0.177, 0.109),
         MN = c(0.147, 0.172, 0.016)) 

hsaccom.took.act.quantile <- hsaccom.took.act.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(hsaccom.took.act.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(hsaccom.took.act.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
```{r summary z scores hs accomplishments took ap exam}

hsaccom.ap.exam.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0.064, 0.083, 0.066),
         EDR = c(0.080, 0.109, 0.094),
         `All 3 EDRs` = c(0.087, 0.177, 0.109),
         MN = c(0.100, 0.172, 0.036)) 

hsaccom.ap.exam.quantile <- hsaccom.ap.exam.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(hsaccom.ap.exam.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(hsaccom.ap.exam.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
```{r summary z scores hs accomplishments cte achievement}

hsaccom.cte.achievement.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0.074, 0.094, 0.091),
         EDR = c(0.082, 0.110, 0.113),
         `All 3 EDRs` = c(0.085, 0.119, 0.121),
         MN = c(0.091, 0.120, 0.084)) 

hsaccom.cte.achievement.quantile <- hsaccom.cte.achievement.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(hsaccom.cte.achievement.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(hsaccom.cte.achievement.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
**attended.ps.within.first.year.hsgrad:** This variable had a strong-ish association with the dependent variable. It gets stronger as the geography increases. 

**ps.grad:** Graduating from a post-secondary institution had a strong-ish association with the dependent variable during grad year +2.

**attended.ps:** Attending a post-secondary institution had a strong-ish association with the dependent variable during grad year +2.

**ps.grad.InstitutionSector:** This variable had the strongest association of all variables. It was strongest at grad year +2.

**highest.cred.level:** This variable had the strongest association of all variables. It was strongest at grad year +2

<br>

#### attended.ps.within.first.year.hsgrad

```{r summary z scores attending post secondary within first year}

post.sec.ps.within.first.year.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( 0.087, NA, NA),
         EDR = c(0.105, NA, NA),
         `All 3 EDRs` = c(0.118, NA, NA),
         MN = c( 0.135, NA, NA)) 

post.sec.ps.within.first.year.quantile <- post.sec.ps.within.first.year.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(post.sec.ps.within.first.year.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(post.sec.ps.within.first.year.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
```{r summary z scores post secondary graduating from post-secondary}

post.sec.ps.grad.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( NA, .115, 0.051),
         EDR = c(NA, 0.133, 0.043),
         `All 3 EDRs` = c(NA, 0.143, 0.035),
         MN = c( NA, 0.160, 0.068)) 


post.sec.ps.grad.quantile <- post.sec.ps.grad.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(post.sec.ps.grad.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(post.sec.ps.grad.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
```{r summary z scores post secondary attended post-secondary}

post.sec.attended.ps.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( NA, 0.071, 0.028),
         EDR = c(NA, 0.133, 0.026),
         `All 3 EDRs` = c(NA, 0.096, 0.021),
         MN = c(NA, 0.092, 0.074)) 

post.sec.attended.ps.quantile <- post.sec.attended.ps.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(post.sec.attended.ps.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(post.sec.attended.ps.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
```{r summary z scores post secondary institution sector graduating post secondary}

post.sec.ps.grad.InstitutionSector.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( NA, 0.209, 0.146),
         EDR = c(NA, 0.253, 0.178),
         `All 3 EDRs` = c(NA, 0.277, 0.188),
         MN = c(NA, 0.309, 0.120)) 

post.sec.ps.grad.InstitutionSector.quantile <- post.sec.ps.grad.InstitutionSector.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(post.sec.ps.grad.InstitutionSector.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(post.sec.ps.grad.InstitutionSector.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
...
```{r summary z scores post secondary highest credential earned}

post.sec.highest.cred.level.zvalues <- pvalue.summary.table.framework %>%
  mutate(County = c( NA, 0.201, 0.137),
         EDR = c(NA, 0.238, 0.157),
         `All 3 EDRs` = c(NA, 0.259, 0.156),
         MN = c(NA, 0.288, 0.070)) 

post.sec.highest.cred.level.quantile <- post.sec.highest.cred.level.zvalues %>%
  gather(key = "geo", value = "zscores", 2:5)

brks <- quantile(post.sec.highest.cred.level.quantile$zscores, probs = seq(.05, .95, .05), na.rm = TRUE)

clrs <- round(seq(152, 251, length.out = length(brks) + 1), 144) %>%
  {paste0("rgb(124,", ., ",", ., ")")}

datatable(post.sec.highest.cred.level.zvalues, class = "cell-border stipe", rownames = FALSE,
          options = list(columnDefs = list(list(className = "dt-center", targets = 1:4)))) %>% 
  formatStyle(names(dem.race.ethnicity.zvalues), backgroundColor = styleInterval(brks, clrs))
