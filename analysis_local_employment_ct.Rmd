...
**avg.unemployment.rate:** The ANOVA table does NOT indicate a relationship between whether an individual has meaningful employment in the same county as their high school two years after graduation and the average unemployment rate in that county.

<br>

**avg.wages.pct.state:** The ANOVA table does indicate a relationship between whether an individual has meaningful employment in the same county as their high school two years after graduation and the average household income in that county. Individuals that graduated from a high school county with higher percentages were more likely to have meaningful employment in the county two years after graduation.
...
**avg.unemployment.rate:** The ANOVA table does indicate a relationship between whether an individual has meaningful employment in the same county as their high school seven years after graduation and the average unemployment rate in that county. The boxplots show that individuals that had meaningful employment in the same county as their high school seven years after graduation had overall lower unemployment rates in those counties.

<br>

**wages.3year.avg:** The ANOVA table does indicate a relationship between whether an individual has meaningful employment in the same county as their high school seven years after graduation and the average household income in that county. The boxplots show that individuals that had meaningful employment in the same county as their high school had higher percentages in those counties.
...
**avg.unemployment.rate:** The p-value  does indicate a relationship between whether an individual has meaningful employment in the same region as their high school the year of graduation and the average unemployment rate in their high school county. The boxplot shows that individuals with meaningful employment in one of the three EDRs likely graduated in a county with slightly lower unemployment. But it is minimal.
...
**total.cte.courses.taken:** The p-value indicates we can reject the null hypothesis and accept that there's a relationship between whether an individual works in the same region as their high school and the number of CTE courses an individual has taken. The boxplot shows that individuals that had meaningful employment in one of the three EDRs the year of graduation were more likely to have taken more CTE courses.
...
**total.cte.courses.taken:** The p-value indicates we can reject the null hypothesis and accept that there's a relationship between whether an individual works in the same region as their high school and the number of CTE courses an individual has taken. The boxplot shows that individuals with meaningful employment in one of the three EDRs two years after graduation more likely took more CTE courses.
...
**avg.wages.pct.state:** The p-value  does indicate a relationship between whether an individual has meaningful employment in the same region as their high school seven years after graduation and the average wages in their high school county as a percent of the state average wages. The boxplot shows that individuals with meaningful employment in one of the three EDRs seven years after graduation were more likely graduated from counties with a lower percentage.
...
**total.cte.courses.taken:** The p-value indicates we can reject the null hypothesis and accept that there's a relationship between whether an individual works in the same region as their high school and the number of CTE courses an individual has taken. The boxplot shows that individuals with meaningful employment in one of the three EDRs sven years after graduation were likely to have taken more CTE courses.
...
* EDR 8 has a significnantly lower proportion of individuals that have meaningful employment in Minnesota the year of graduation - 17.9% compared to 18.8% in EDR 6W and 22% in EDR 6E.
...
* a significantly larger number of individuals that did NOT attend a post-secondary institution had meaningful employment in the same region as their high school - 3,019 observed vs. 2,440 expected.
...
* This same group of individuals had more people with meaningful employment in the same region as their high school than expected - 2,868 vs. 1,965 expected.
...
* These same individuals had a significantly higher number have meaningful employment in the same region as their high school than expected - 3,019 observed vs. 2,440 expected.
...
* A larger proportion of black individuals (46.5%) had meaningful employment in Minnesota compared to AI, Asian/PI and White individuals. 
* A larger observed number of Black individuals had meaningful employment in Minnesota than what was expected - 80 individuals vs. 97 expected.
* A larger proportion of hispanic individuals (48.8%) had meaningful employment in Minnesota compared to all other races/ethnicities. 
* A larger observed number of hispanic individuals had meaningful employment in Minnesota than what was expected - 403 observed vs. 717 expected.
...
* Location match - county
    * Demographic variables
      + Hispanic has a significantly higher proportion of individuals working in the same county as their high school at graduation, but that proportion advantage decreases over time, although still statistically significant.
