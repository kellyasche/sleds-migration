...
master <- read_csv("Data/SLEDS/K12 Enrollment/K12Enrollment-master.csv") %>%
...
The schools with the highest percent of graudates/observations are located in Kandiyohi, Lyon and McLeod counties. Each of those have between 10% and 13% of high school grduates since 2006. 
