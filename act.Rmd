...
The cross-tabs for the percentage of students who have taken the ACT by RUCA category has a p-value of less than .01, indicating that RUCA category is related. However, the percentage of students graduating from high schools in counties within these RUCA groups are very close. Nearly two-thirds of students across all RUCA groups take the ACT exam. The significant difference seems to be in the higher percentages in the entirely rural and urban/town/rural mix county group, which are closer to 70% of all students.
...
Again, the cross-tabs indicate that EDR and the percentage of students taking the ACT are related but the percentages are very close to each other when breaking it down by EDR. 
...
CrossTable(act.taken.edr.cross.tabs$edr, act.taken.edr.cross.tabs$act.taken, expected = TRUE, prop.t = FALSE, prop.c = FALSE, prop.chisq = FALSE)
...
Finally, here's a look at the percentages by county. For the most part, the percentages are pretty close. The percentage of students who've taken the ACT ranges from 54.4% in Chippewa to 71.6% in Lac qui Parle County. 
